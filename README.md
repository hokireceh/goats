...
🔗 **Register**: [Goats](https://t.me/realgoats_bot/run?startapp=5768d546-4887-4a3b-9737-4f5842ec9408)
...
- Linux / Termux
```
git clone https://github.com/hokireceh/goats.git
```
```
cd goats
```
...
| -------------------------------- | ------------------- |
| `main.js` `datas.txt` | `proxies.txt` `config.json` |
